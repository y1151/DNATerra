**DNA-Fountain**
This a Python 3 port of Yaniv Ehrlich's orignal dna-fountain:
https://github.com/TeamErlich/dna-fountain

Porting completed by:
	Yihang Du, Wenrong Wu and Justin Brody, all of Franklin and
	Marshall College.  Contact jbrody2@fandm.edu with questions.

For now, receiver.py is not ported; use decode.py instead.
...
# Decoding:
python ~/Downloads/fountaincode/decode.py \
